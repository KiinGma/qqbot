...
const (
	...
	ErrorPasswordCode            = 40010000
	ErrorPasswordMsg             = "密码错误"
	ErrorPasswordNilCode         = 40020000
	ErrorPasswordNilMsg          = "密码不能为空"
	ExcessiveAmountCode          = 40030000
	ExcessiveAmountMsg           = "输入的金额超出指定值 , 最大允许10000 , 最小允许1"
	ErrorAmountCode              = 40040000
	ErrorAmountMsg               = "输入金额的格式错误"
	ErrorUserNotFoundCode        = 40050000
	ErrorUserNotFoundMsg         = "用户不存在"
	ErrorModelNotFoundCode       = 40060000
	ErrorModelNotFoundMsg        = "当前model不支持"
	ErrorInsufficientBalanceCode = 40070000

	ErrorServerOccurredCode int    = 50010000
	ErrorServerOccurredMsg  string = "服务器内部发生代码执行错误 "
	ErrorServerDbCode       int    = 50020000
	ErrorServerDbMsg        string = "服务器数据库发生代码执行错误, "
	ErrorAlipayServerCode   int    = 50030000
	ErrorAlipayServerMsg    string = "支付宝服务没有准备好, "
)
