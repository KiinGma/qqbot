...
type YuanShenSimpleGaChaLog struct {
	Name     string `json:"name"`
	RankType string `json:"rank_type"`
}

func (i *YuanShenGaChaLog) ToJson() []byte {
	data, _ := json.Marshal(i)
	return data
}

func (i *YuanShenGaChaLog) ToStruct(data []byte) {
	_ = json.Unmarshal(data, i)
}

var YuanShenRoleData = `
{
    "10000002":{
        "Element":"Ice",
        "Consts":[
